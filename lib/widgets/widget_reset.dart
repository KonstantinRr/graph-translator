...
class WidgetGenerator extends StatefulWidget {
  ...
  const WidgetGenerator({@required this.controller,
      ...
      child: Column(
        children: <Widget> [
          Container(
            ...
            child: Text('Generate', style: theme.textTheme.button
              ...
              Column(
                children: [
                  Container(
                    ...
                    alignment: Alignment.center,
                    child: Text('Nodes ${sliderNodes.round()}', style: style,),
                  ),
                  Container(
                    height: 40.0, width: 70.0,
                    alignment: Alignment.center,
                    child: Text('Edges ${sliderEdges.round()}', style: style,),
                  )
                ],
              ),
              Column(
...
class WidgetSimulate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ElevatedButton(
      onPressed: () {
        controller.updateGraphState((g) { g.simulatePositions(1000); });
      },
      style: ElevatedButton.styleFrom(
        primary: Colors.white, // background
        shape: new RoundedRectangleBorder(
      ...
      child: Container(
        ...
        width: 200.0,
        alignment: Alignment.center,
        child: Text('Simulate', style: theme.textTheme.button
          .copyWith(color: Colors.black),),
      ),
    );
  }
